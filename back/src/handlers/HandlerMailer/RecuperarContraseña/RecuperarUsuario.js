    ...
    if (usuario) {
      if (usuario.estado === "eliminar") {
        ...
        const mailDeNotificacion = {
          ...
          mensaje: `¡Felicitaciones! Has recuperado tu usuario ${correo}. Tu nueva contraseña es: ${nuevaContraseña}`,
        };
        ...
        return res.status(400).json({ error: "El usuario no está marcado como eliminado" });
      }
    } else {
