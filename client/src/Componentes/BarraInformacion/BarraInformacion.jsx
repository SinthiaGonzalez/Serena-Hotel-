const BarraInformacion = () => {
  return (
    <div className="h-[90px] bg-naranja flex items-center justify-between px-8 mt-16 mb-16">

      <div className="flex items-center space-x-4 lg:ml-28 lg:mr-[-100px]">
        <div className="border-l-4 border-gray-400 p-1 lg:px-4 lg:py-1">
      ...
      <div className="flex items-center space-x-4">
        <div className="border-l-4 border-gray-400 p-1 lg:px-4 lg:py-1">
          <div className="text-center">
            <div className="text-2xl lg:text-4xl font-bold mb-2">20.000+</div>
      ...
      <div className="flex items-center space-x-4">
        <div className="border-l-4 border-gray-400 p-1 lg:px-4 lg:py-1 lg:ml-[-100px] lg:mr-[250px]">
          <div className="text-center">
            <div className="text-2xl lg:text-4xl font-bold mb-2">20</div>
