...
const LoginCliente = () => {
  ...
  return (
    ...
    >
      <div
        className="relative flex flex-col text-gray-700 bg-white shadow-md w-96 bg-clip-border"
      ...
      >
        <div className="flex flex-col gap-4 p-6">
          <a
            href="#signup"
            style={{ marginLeft: "8%" }}
            className="text-left block ml-1 font-sans text-xs antialiased font-bold leading-normal text-naranja"
          >
            🡰 Volver
          </a>
          <p
            style={{ marginLeft: "17%", marginBottom: "3%" }}
          ...
          <button
            className="flex h-11 w-full min-w-[200px] text-left"
          ...
          <div className="flex h-11 w-full min-w-[200px]">
            <p
              style={{ width: "11%", background: "#444444", marginLeft: "17%" }}
            ...
            <input
              style={{ width: "57%", background: "#444444" }}
          ...
          <div className="flex h-11 w-full min-w-[200px]">
            ...
            <input
              style={{ width: "57%", background: "#444444", paddingTop: "4%" }}
      ...
      <div
        className="block flex flex-col text-gray-700 bg-white shadow-md w-96 bg-clip-border"
        style={{
          width: "40%",
      ...
      >
        <div className="p-6 pt-0">
          <h1
            style={{ marginLeft: "7%" }}
            className="flex  mt-6 font-sans text-2xl antialiased font-extrabold  leading-normal text-left"
          >
            ¿NO TIENES <br /> UNA CUENTA?
          </h1>
          <p
            style={{ marginLeft: "7%", marginTop: "30%", marginBottom: "39%" }}
            className="text-2xl antialiased font-extrabold text-left"
          >
