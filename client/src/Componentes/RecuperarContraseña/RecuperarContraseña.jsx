...
const RecuperarContraseña = () => {
  ...
  return (
    <div
      className="relative bg-cover bg-center h-screen text-white text-center justify-center"
      style={{
        backgroundImage:
    ...
    >
      <div className="relative text-gris bg-blanco shadow-md bg-clip-border justify-center w-2/3 p-2 rounded-l-lg">
        <div className="flex flex-col gap-4 p-6 mt-8 ">
          <a
            href="/logearse"
            class="ml-[8%] mb-16 text-left block font-inter text-base antialiased font-bold text-naranja text-inter hover:scale-105 w-1/6"
          >
            🡰 Volver
          </a>
          ...
          <div className="flex flex-row w-2/3 bg-verde ml-[18%] relative rounded-lg mb-12">
